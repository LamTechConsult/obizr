...
////////////////////////////////////////////////////////////////////////////////
	...
	function getMyReviews(uid) {
		...
		var nodes = {"nodes":[{"node":{"cid":"149","nid":"40651","revieweruid":"62776","biztitle":"The Place @ Tokeh Beach Restaurant","reviewtitle":"example","reviewratings":"4/5","reviewdateposted":"11 hours 19 min ago","reviewmessage":"example","bizimage":{"src":"http://slbr.sl/sites/default/files/styles/bis_mob_view/public/default_images/restaurant-banner.jpg?itok=bh0Y0njE","alt":""}}},{"node":{"cid":"148","nid":"26701","revieweruid":"62776","biztitle":"Roman Catholic Primary - 100889","reviewtitle":"Nice","reviewratings":"4/5","reviewdateposted":"2 days 22 hours ago","reviewmessage":"Udushs","bizimage":{"src":"http://slbr.sl/sites/default/files/styles/bis_mob_view/public/default_images/education-banner_0.jpg?itok=YaNrJfwI","alt":""}}},{"node":{"cid":"145","nid":"37331","revieweruid":"62776","biztitle":"KingHarman Rd Sat. (EPI) Hospital","reviewtitle":"Nice Services","reviewratings":"5/5","reviewdateposted":"1 week 2 days ago","reviewmessage":"Nice Services","bizimage":{"src":"http://slbr.sl/sites/default/files/styles/bis_mob_view/public/default_images/health-banner.jpg?itok=FSNhPuyG","alt":""}}},{"node":{"cid":"129","nid":"40806","revieweruid":"62776","biztitle":"Lac's Villa Guest House","reviewtitle":"Test","reviewratings":"5/5","reviewdateposted":"2 weeks 1 day ago","reviewmessage":"Test","bizimage":{"src":"http://slbr.sl/sites/default/files/styles/bis_mob_view/public/default_images/restaurant-banner.jpg?itok=bh0Y0njE","alt":""}}}]};
	...
	function getMyBusinesses (uid) {
		var defer = $q.defer();
		if (myBusinesses == null || (Date.now() - lastFetched) > 60 * 10000) {
			DataService.fetchMyBusinesses(uid).success(function (data) {
		        myBusinesses = data;
		        defer.resolve(myBusinesses);
		        lastFetched = Date.now();
		    }).catch(function (error) {
		        defer.reject(error);
		    });
